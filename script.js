...
(function() {
  // Set graduation date (June 27, 2025, 00:00:00 local time)
  var countDownDate = new Date("June 27, 2025 00:00:00").getTime();
  ...
  function updateCountdown() {
    ...
    if (distance < 0) {
      document.getElementById("countdown-timer").innerHTML = "🎓 Congratulations, Year 11!";
